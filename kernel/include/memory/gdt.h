...
// below defintions are graciously borrowed from the osdev wiki
 ...
 * @param limit the limit of the descritor
 * @param flag the flag of the descriptor
 * @return uint64_t the descriptor to be returned 
 */
